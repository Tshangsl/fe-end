...
// 2.可选参数 加? 可以设置可选参数
function test1(name:string,age:number,gender?:string){
    console.log(name,age,gender);
}
test1('lisi',23);

//3. 默认参数
function test2(name:string,age:number,gender:string='male'){
    console.log(name,age,gender);
}
test2('lisi',23);

// 4.剩余参数
function test3(name:string,age:number,...args:any[]){
    var str = '';
...
// 5.返回值可以有类型
function test4(name:string,age:number):string{
